...
export default function Modal1({ open, onClose, children }: { open: boolean, onClose: any, children: any }) {
    return (
        <div onClick={onClose} className={`fixed inset-0 flex justify-center transition-colors ${open ? 'visible bg-gradient-to-br from-indigo-950 to-slate-950' : 'invisible'}`}>
